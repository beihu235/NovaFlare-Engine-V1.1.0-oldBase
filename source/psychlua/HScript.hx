...
class HScript extends SScript
{
	...
	{
		#if LUA_ALLOWED
		funk.Lua_helper.add_callback(lua, "runHaxeCode", function(codeToRun:String) {
		...
		funk.Lua_helper.add_callback(lua, "addHaxeLibrary", function(libName:String, ?libPackage:String = '') {
			#if SScript
			initHaxeModule();
			try {
				var str:String = '';
